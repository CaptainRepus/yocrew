...
<template>
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <div class="py-2 pt-0 md:mt-20 w-full z-[50000] md:pt-0 md:px-0 bg-slate-900">
        <jumbotron />
        <div class="flex flex-col justify-center md:flex-col md:px-20">
          ...
          <div class="flex justify-center flex-col md:flex-row gap-3 md:mt-3 max-md:px-5">
            <div class="w-full md:flex-1 max-md:hidden">
              <newestArticle />
            </div>
