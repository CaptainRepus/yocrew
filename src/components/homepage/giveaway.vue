<template>
    <div class="animate relative w-full h-52 md:h-28 bg-green-600 shadow-md border border-gray-700 rounded-lg md:rounded-none overlfow-x-hidden mt-[1rem] mb-5">
        ...
        <div class="flex flex-col p-2 md:flex-row justify-center items-center4">
            <div class="md:w-1/3">
            ...
            <h2 class="p-1 text-white text-md text-center">
             ...
             <div class="flex justify-center items-center md:w-1/4" >
                <button class="p-3 text-white text-md text-center bg-green-500 border border-green-900 rounded-lg mt-2 md:mt-0">
